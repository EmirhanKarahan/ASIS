...
final class FloatingPanelContentTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        NSLayoutConstraint.activate([
            pointsInHeaderView.widthAnchor.constraint(equalToConstant: 180),
            pointsInHeaderView.heightAnchor.constraint(equalToConstant: 115),
    ...
    override func tableView(_ tableView: UITableView, titleForHeaderInSection section: Int) -> String? {
        if section == 0 {
            return "Başlangıç Noktası"
        }
        return "Varış Noktası"
    }
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        targetPoint = HowToGoPoint(pointName: stops[indexPath.row].name ?? "?", coordinate: coordinate)
...
final class PointsInHeaderView : UIView {
    ...
    override init(frame: CGRect) {
        ...
        NSLayoutConstraint.activate([
            ...
            fromLabel.widthAnchor.constraint(equalToConstant: 120),
            ...
            toLabel.widthAnchor.constraint(equalToConstant: 120),
